...
void Transform3D::setIdentityModelMatrix(float matrix[4][4]){
	ModelMatrix[0][0] = matrix[0][0];	
	ModelMatrix[0][1] = matrix[0][1];	
	ModelMatrix[0][2] = matrix[0][2];	
	ModelMatrix[0][3] = matrix[0][3];
	ModelMatrix[1][0] = matrix[1][0];	
	ModelMatrix[1][1] = matrix[1][1];	
	ModelMatrix[1][2] = matrix[1][2];	
	ModelMatrix[1][3] = matrix[1][3];
	ModelMatrix[2][0] = matrix[2][0];	
	ModelMatrix[2][1] = matrix[2][1];	
	ModelMatrix[2][2] = matrix[2][2];	
	ModelMatrix[2][3] = matrix[2][3];
	ModelMatrix[3][0] = matrix[3][0];	
	ModelMatrix[3][1] = matrix[3][1];	
	ModelMatrix[3][2] = matrix[3][2];	
	ModelMatrix[3][3] = matrix[3][3];
} 
